    ...
    public void initAndLoop() {
        ...
        if (factoryTest != SystemServer.FACTORY_TEST_LOW_LEVEL) {
            ...
            if (!disableNonCoreServices) {
             ...
             //Added this block of code the register the test service
            try {
            ...
            Slog.e(TAG, "Failure starting TestService Service", e);
                ...
                //Added this block of code the register the pbd service
            try {

           Slog.i(TAG, "Pbd Service");
           ServiceManager.addService("pbd", new PbdService(context));

            } catch (Throwable e) {
            Slog.e(TAG, "Failure starting PbdService Service", e);
            } 
                //Code block ends here.

//PbdLocation is a customized version of android.location.Location
//It is used so that the location permission is not required by the calling app.
 ...
 */
public class PbdLocation implements Parcelable {
    /**
     ...
     */
    public PbdLocation(String provider) {
        mProvider = provider;
    }
     ...
     */
    //Changed to convert from Location to PbdLocation
    //All methods changed to get methods
    public void set(Location l) {

        Log.i("PbdLocation", "Into the Set Function");
        ...
        String a = "l.getLatitude is: " + b;
        Log.i("PbdLocation", a );

        a = "After being set m Latitude is " + mLatitude; 
        Log.i("PbdLocation", a );
     ...
     */
    //Changed methods to get methods to get from android.location.Location class
    ...
    //Commented out else statement as could not find the TimeUtils.formatDestinati
    @Override
    ...
    //Changed for PbdLocation to Location
    public static final Parcelable.Creator<PbdLocation> CREATOR =
        new Parcelable.Creator<PbdLocation>() {
        @Override
        public PbdLocation createFromParcel(Parcel in) {
            String provider = in.readString();
            PbdLocation l = new PbdLocation(provider);
            l.mTime = in.readLong();
        ...
        @Override
        public PbdLocation[] newArray(int size) {
            return new PbdLocation[size];
        }
    };
